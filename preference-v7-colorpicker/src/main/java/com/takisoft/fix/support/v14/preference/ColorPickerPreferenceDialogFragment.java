...
public class ColorPickerPreferenceDialogFragment extends PreferenceDialogFragment implements OnColorSelectedListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ColorPickerDialog.Params params = new ColorPickerDialog.Params.Builder(getActivity())
