...
/**
 * As a user requested, here's a variant of PreferenceFragmentFix that allows one to fully
 * customize the dividers between categories and items.
 */
abstract public class PreferenceFragmentDividers extends PreferenceFragment {
    /**
     ...
     *
     * @param flags The preferred divider drawing flags. Check {@link PreferenceFragmentDividers} for possible values.
     */
    ...
    Drawable getDividerDrawable() {
        TypedArray a = getPreferenceManager().getContext().obtainStyledAttributes(null, R.styleable.PreferenceFragment, R.attr.preferenceFragmentStyle, 0);
    ...
    protected class DividerItemDecoration extends RecyclerView.ItemDecoration {
        ...
        public void setDivider(@Nullable Drawable divider) {
            ...
            this.divider = divider;
            PreferenceFragmentDividers.this.getListView().invalidateItemDecorations();
        }
