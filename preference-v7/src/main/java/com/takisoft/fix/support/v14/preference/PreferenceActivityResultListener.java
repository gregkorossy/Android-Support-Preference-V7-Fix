 ...
 * using the supplied {@link PreferenceFragment} fragment manually (e.g. adding a fragment to
 * it).
 */
public interface PreferenceActivityResultListener {
     ...
     */
    void onPreferenceClick(@NonNull PreferenceFragment fragment, @NonNull Preference preference);
